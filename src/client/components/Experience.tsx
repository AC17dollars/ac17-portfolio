...
export const Experience: React.FC = () => {
  ...
  return (
    <section
      id="resume"
      className="py-20 px-6 md:px-12 bg-brand-dark border-t border-white/5"
    >
      <div ref={ref} className="max-w-7xl mx-auto">
        ...
        <div
          className={`grid grid-cols-1 md:grid-cols-2 gap-16 transition-all duration-1000 ease-out transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"}`}
        >
          {/* Education Column */}
          <div>
            <h3 className="text-2xl md:text-3xl font-serif italic text-brand-accent mb-10">
              Education
            </h3>
            ...
            <div className="space-y-12">
              <div className="relative pl-8 border-l border-white/10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  I have completed Undergraduate Degree in Electronics,
                  Communication & Information Engineering. I obtained 80.01%
              ...
              <div className="relative pl-8 border-l border-white/10">
                ...
                <p className="text-sm font-serif italic text-gray-300 mb-2">
                  Valmiki Shiksha Sadan, NEB
                </p>
                <p className="text-gray-400 text-sm leading-relaxed">
                  I have completed High School studies / +2 certification in
                  Science stream. I obtained 3.82 CGPA.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-12">
              ...
              <div className="relative pl-8 border-l border-white/10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Developed responsive and interactive user interfaces for
                  digital solutions.
                </p>
              </div>
              ...
              <div className="relative pl-8 border-l border-white/10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Lead in the coordination, development, and implementation of
                  software projects.
                </p>
              </div>
            </div>
