      ...
      <div ref={ref} className="max-w-6xl w-full">
        <div className={`transition-all duration-1000 ease-out transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
          <h2 className="text-4xl md:text-6xl lg:text-7xl leading-[1.1] font-sans text-gray-200">
            As a <span className="font-serif italic text-brand-accent">Software Engineer</span>, I focus on the architecture of <span className="text-gray-400">intelligent systems</span> and the elegance of <span className="font-serif italic text-white">robust infrastructure</span>.
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mt-20">
          ...
          <div className={`md:col-span-8 lg:col-span-7 transition-all duration-1000 delay-300 ease-out transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-20 opacity-0'}`}>
            <p className="text-lg md:text-xl text-gray-400 leading-relaxed font-light">
              I specialize in building full-stack applications with <span className="text-white">React</span> and <span className="text-white">TypeScript</span>, while exploring the depths of AI through computer vision projects like YOLOv8-based autonomous solvers.
            </p>
